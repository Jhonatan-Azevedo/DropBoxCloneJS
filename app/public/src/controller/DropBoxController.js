class DropBoxController {
  ...
  connectFireBase() {
    const firebaseConfig = {
      apiKey: "AIzaSyDnQ_CV_KhFuxXWhNANemx6koEulfUnqZk",
      authDomain: "dropboxclone-fe293.firebaseapp.com",
      databaseURL: "https://dropboxclone-fe293-default-rtdb.firebaseio.com",
      projectId: "dropboxclone-fe293",
      storageBucket: "dropboxclone-fe293.appspot.com",
      messagingSenderId: "450992411552",
      appId: "1:450992411552:web:4c065655a263cbdc7ccac5",
      measurementId: "G-FZ1HNB669Q",
    };
    ...
    for (let i = 0; i < this.currentFolder.length; i++) {
      ...
      if (i + 1 === this.currentFolder.length) {
        ...
        span.innerHTML = `<span class="ue-effect-container uee-BreadCrumbSegment-link-0">
                          ...
                          <svg width="24" height="24" viewBox="0 0 24 24" class="mc-icon-template-stateless" style="top: -2px; position: relative;">
